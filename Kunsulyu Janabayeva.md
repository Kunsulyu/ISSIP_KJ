...
| Third-Party Disclosure       |        5      | Anthropic is committed to privacy and security in handling personal data. The Privacy Policy details data collection, usage, and user rights. Personal data is shared with affiliates, service providers, and business partners, and may be transferred internationally with protective measures. Anthropic ensures compliance with legal requirements and provides users control over their data, including rights to access, deletion, and correction.                       |
